...
export const CHAT_MIN_HEIGHT = 280;
export const CHAT_MAX_HEIGHT = Math.min(SCREEN_HEIGHT * 0.88, 760);
...
export const chatStyles = StyleSheet.create({
  chatWindow: {
    ...
    right: 14,
    width: CHAT_WIDTH,
    // height is now dynamic — managed via state in the component
    borderRadius: 16,
    overflow: 'hidden',
    zIndex: 9998,
    backgroundColor: '#fff',
  ...
  // ── Resize Handle (top drag bar) ──
  resizeHandle: {
    width: '100%' as any,
    height: 18,
    backgroundColor: 'rgba(74,140,42,0.07)',
    ...
    flexShrink: 0,
    ...(Platform.OS === 'web'
      ? ({ cursor: 'ns-resize', userSelect: 'none' } as any)
      : {}),
  },
  resizeHandlePill: {
    width: 36,
    height: 4,
    borderRadius: 2,
    backgroundColor: 'rgba(74,140,42,0.35)',
  },
  resizeHandleActive: {
    backgroundColor: 'rgba(74,140,42,0.15)',
  },
