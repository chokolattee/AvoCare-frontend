...
// ── Palette (AvoCare brand — matches FruitScanScreen) ────────
// Page bg:       #e8f2de  (light sage)
// Header bg:     #ddeece
// Card bg:       #f4faed  (pale sage)
// Image area:    #d8edca
// Accent green:  #7aad4e  (bright green)
// Dark btn:      #3d6b22  (primary action)
// Text primary:  #2e4420
...
export const getStyles = (isWide: boolean) => StyleSheet.create({
  ...
  // Scan header (mobile title inside dark camera area)
  scanHeader: {
  ...
  // Detection banner
  detectionBanner: {
    backgroundColor: '#3d6b22', flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    paddingVertical: 8, paddingHorizontal: 14, borderRadius: 10, marginBottom: 14, gap: 6,
  },
  detectionBannerText: { color: '#fff', fontSize: 12, fontWeight: '700', letterSpacing: 0.4 },
  ...
  probabilityLabel: { fontSize: 11, fontWeight: '600', color: '#333', width: 120, marginRight: 6, textTransform: 'capitalize' },
  ...
  probabilityValue: { fontSize: 11, fontWeight: '700', color: '#555', width: 44, textAlign: 'right' },
  ...
  popupTitle: { fontSize: 20, fontWeight: '800', color: '#2e4420', marginBottom: 6, letterSpacing: 0.2 },
  popupSubtitle: { fontSize: 14, color: '#3d6b22', textAlign: 'center', lineHeight: 20, marginBottom: 24 },
  popupPrimaryBtn: {
  ...
  popupSecondaryBtn: { paddingVertical: 10, paddingHorizontal: 20 },
